...
int  env_init(void)
{
	...
	crc1_ok = (tinf_crc32(0, flash_addr->data, ENV_SIZE) == flash_addr->crc);
	crc2_ok = (tinf_crc32(0, flash_addr_new->data, ENV_SIZE) == flash_addr_new->crc);
...
void env_relocate_spec (void)
{
	...
	if (flash_addr_new->flags != OBSOLETE_FLAG &&
	    tinf_crc32(0, flash_addr_new->data, ENV_SIZE) ==
	    flash_addr_new->crc) {
