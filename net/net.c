...
#if defined(CFG_VITESSE_73XX_NOPHY) || defined (CONFIG_AG7240_SPEPHY) || defined(CFG_REH132) || defined(CONFIG_MACH_QCA956x)
	/*
...
/* for auto reboot after tftp failed, wuchao@2014-10-28 */
#ifdef FW_RECOVERY
...
//		return;
#endif
/* end change by wuchao@2014-10-28 */
